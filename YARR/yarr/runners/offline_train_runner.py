...
class OfflineTrainRunner():
    ...
    def start(self):
        ...
        dataset = self._wrapped_buffer.dataset() # 这个dataset是pytorch.util.dataset 类
        ...
        for i in range(start_iter, self._iterations):
            ...
            # 打印损失和时间
            print(f"Iteration {i}: Loss = {loss}, Sample Time = {sample_time:.4f}s, Step Time = {step_time:.4f}s\n")
